$(function(){
  ...
  $(".wrap").hasClass("main") ? $(".header").removeClass("is_active") : $(".header").addClass("is_active")
  ...
  $(window, document).scroll(function(){
    ...
    let olimSectionTop = $(".section_olim").offset().top - 100;
    // let workSectionTop = $(".section_works").offset().top - 100;

    //header scroll
    if($(".wrap").hasClass("main")){

      if(scrollTopVal > olimSectionTop){
